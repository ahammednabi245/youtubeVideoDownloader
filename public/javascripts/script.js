(function($) {
  ...
  app.updateContent = function(data) {
    if (data.player_response && data.player_response.videoDetails && data.player_response.videoDetails.thumbnail && data.player_response.videoDetails.thumbnail.thumbnails && data.player_response.videoDetails.thumbnail.thumbnails[2]) {
